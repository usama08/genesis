...
class _PartnerPreferencesState extends State<PartnerPreferences> {
  PartnerPreferencesController controller =
      Get.put(PartnerPreferencesController());
  int? minAge;
  int? maxAge;
  String? minHeight;
  String? maxHeight;
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ListTile(
                      ...
                      subtitle: Obx(
                        () => Text(controller.maxAge.value != '' ||
                            ...
                            ? '${controller.minAge.value} to ${controller.maxAge.value}'
                            : 'Select age range'),
                      ),
                    ...
                    ListTile(
                              ...
                              children: [
                                ...
                                SizedBox(
                                  ...
                                  child: DropdownButtonFormField<String>(
                                      ...
                                      items: controller.minHeightRange
                                ...
                                SizedBox(
                                  ...
                                  child: DropdownButtonFormField<String>(
                                      ...
                                      items: controller.maxHeightRange
                                          .map((e) => DropdownMenuItem<String>(
                                              value: e,
                                              child: Text(
                                                e.toString(),
                      ...
                      title: Text('Height Range'),
                      subtitle: Obx(
                        () => Text(controller.minHeight.value != '' ||
                                controller.maxHeight.value != ''
                    ...
                    ListTile(
                              ...
                              children: [
                                ...
                                SizedBox(
                                  ...
                                  child: DropdownButtonFormField<String>(
                                      ...
                                      hint:
                                          const Text('Select Maritial status'),
                                      style:
                      ...
                      subtitle: Obx(
                        () => Text(controller.selectedMartialStatus.value != ''
                            ? '$maritialStatus'
                            : 'Select status'),
                      ),
                      trailing: Icon(Icons.arrow_forward_ios),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ListTile(
                                ...
                                SizedBox(
                                  ...
                                  child: DropdownButtonFormField<String>(
                                      ...
                                      onChanged: (value) {
                                        ...
                                        controller.selectedTongue.value =
                                            '$motherTongue';
                                        print(motherTongue);
                                      }),
                                ),
                      ...
                      subtitle: Obx(() => Text(controller.selectedTongue != ''
                          ? '$motherTongue'
