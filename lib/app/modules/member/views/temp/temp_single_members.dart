...
import 'package:genesis/core/functions/check_user_firebase.dart';
import 'package:get/get.dart';
import 'package:card_swiper/card_swiper.dart';
import 'package:simple_fontellico_progress_dialog/simple_fontico_loading.dart';
import '../../../../../core/functions/chatroom_creation.dart';
import '../../../../../core/values/constants.dart';
import '../../../inbox/widgets/ChatRoomModel.dart';
import '../../../inbox/widgets/ChatRoomPage.dart';
import '../../../inbox/widgets/UserModel.dart';
import './temp_member_model.dart';

class TempSingleMembers extends StatelessWidget {
  final Profiles doc;
  const TempSingleMembers({Key? key, required this.doc}) : super(key: key);
            ...
            doc.userImages!.isNotEmpty
                ...
                : SizedBox(
                    ...
                    child: Image.network(
                      ...
                      doc.defaultImg!.isEmpty
                          ? ''
                          : doc.defaultImg!.first.toString(),
                      fit: BoxFit.contain,
                      errorBuilder: (context, Object, StackTrace) {
                        return Center(child: Text('Image is not added'));
                      },
                    ),
                  ),
                        ...
                        InkWell(
                            onTap: () async {
                              ...
                              await addDocumentIfNotExists(
                                  ...
                                  UserModel(
                                      uid: doc.uid,
                                      profilepic: doc.defaultImg!.isEmpty
                                          ? ''
                                          : doc.defaultImg?.first,
